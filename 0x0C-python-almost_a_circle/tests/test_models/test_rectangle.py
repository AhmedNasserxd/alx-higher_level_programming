...
- With explicit file: python3 -m unittest tests/test_models/test_rectangle.py
"""
...
class TestPep8(unittest.TestCase):
    """Pep8 tests for models/rectangle.py & tests/test_models/test_rectangle.py"""
...
class TestRectangle(unittest.TestCase):
    ...
    def test_attributes_validated(self):
        """Test attributes are validated before being set."""
    ...
    def test_invalid_args(self):
        ...
        """Test too few args given throws error."""
        with self.assertRaises(TypeError):
            Rectangle(1)
            Rectangle()
            Rectangle(None)
