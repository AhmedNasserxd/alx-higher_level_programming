...
To run:
- With discover: python3 -m unittest discover tests
- With explicit file: python3 -m unittest tests/test_models/test_base.py
"""
...
class TestPep8(unittest.TestCase):
    """Pep8 tests for models/base.py & tests/test_models/test_base.py"""

    def test_pep8(self):
        """Check code against PEP8 style."""
...
class TestBase(unittest.TestCase):
    ...
    # Test loading list of instances from JSON string representation of dict in file
