...
Unittest classes:
    TestBaseInstantiation - Tests for instantiating the Base class.
    TestBaseToJsonString - Tests for the to_json_string method of Base class.
    TestBaseSaveToFile - Tests for the save_to_file method of Base class.
    TestBaseFromJsonString - Tests for the from_json_string method of Base class.
    TestBaseCreate - Tests for the create method of Base class.
    TestBaseLoadFromFile - Tests for the load_from_file method of Base class.
    TestBaseSaveToFileCsv - Tests for the save_to_file_csv method of Base class.
    TestBaseLoadFromFileCsv - Tests for the load_from_file_csv method of Base class.
"""
import os
import unittest
...
class TestBaseInstantiation(unittest.TestCase):
    """Tests for instantiating the Base class."""
